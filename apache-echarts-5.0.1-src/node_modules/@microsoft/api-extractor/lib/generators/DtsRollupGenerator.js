        ...
        for (const entity of collector.entities) {
            if (entity.astEntity instanceof AstImport_1.AstImport) {
                ...
                const maxEffectiveReleaseTag = symbolMetadata
                    ? symbolMetadata.maxEffectiveReleaseTag : api_extractor_model_1.ReleaseTag.None;
        ...
        if (recurseChildren) {
            for (const child of span.children) {
                ...
                if (AstDeclaration_1.AstDeclaration.isSupportedSyntaxKind(child.kind)) {
                    ...
                    const releaseTag = collector.fetchMetadata(childAstDeclaration).effectiveReleaseTag;
