...
class DocCommentEnhancer {
    ...
    _analyzeNeedsDocumentation(astDeclaration, metadata) {
        if (astDeclaration.declaration.kind === ts.SyntaxKind.Constructor) {
            ...
            if (declarationMetadata.effectiveReleaseTag === api_extractor_model_1.ReleaseTag.Internal) {
        ...
        if (astDeclaration.declaration.kind === ts.SyntaxKind.SetAccessor) {
            if (metadata.tsdocComment) {
                this._collector.messageRouter.addAnalyzerIssue("ae-setter-with-docs" /* SetterWithDocs */, `The doc comment for the property "${astDeclaration.astSymbol.localName}"`
